...
export const AddCar = () => {
    ...
    const funcOnChange1 = (text) => {
        ...
        setSelectedCarModel(carModels.find(cm => cm.id === id))
        setNewCar({ ...newCar, "carModelDto": selectedCarModel, "carModelId": selectedCarModel.id })
    ...
    return <>
        <div id="add">
            ...
            <div className="ltr">
                {carModels && <Select funcOnChng={funcOnChange1} set={setSelectedCarModelString} list={carModels.map(i => i.id + ": " + i.model + ", " + i.company+", "+i.carTypeDto.description ?i.company+i.carTypeDto.description:"")} text={"car model"}></Select>}
